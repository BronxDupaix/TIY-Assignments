...
let name = "Bronson"
let lastName = 60
let lastNameLabel = name + String(lastName)
lastNameLabel
...
let cats = 4
let dogs = 6
let catSummary = "I have \(cats) cats"
let animalSummary = "I have \(cats + dogs) animals"
